...
## 6. **[WIP]** Withdrawal Limits

- Optional global and per-user constraints:
    - Maximum withdrawal amount per transaction.
    - Daily withdrawal limits per user and global total.
...
- **[WIP]** Ensure **deterministic log ordering** for consistent off-chain indexing and auditability.
